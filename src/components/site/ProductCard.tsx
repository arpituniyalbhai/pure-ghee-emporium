...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link to={href} className="group flex h-full flex-col overflow-hidden rounded-[1.5rem] border border-border bg-card shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-lift">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="mt-2 font-display text-xl leading-snug font-semibold">{product.name}</h3>
